...
const s = StyleSheet.create({
  ...
  skipTxt: { fontSize: 14, fontFamily: 'Nunito-Medium', color: '#6b7280' },
  slide: { width: SW, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40 },
  slideTitle: { fontSize: 34, fontFamily: 'Cormorant-Light', color: '#e8eaed', textAlign: 'center', letterSpacing: 0.5, marginBottom: 16 },
  slideSub: { fontSize: 16, fontFamily: 'Nunito-Regular', color: '#9ba3af', textAlign: 'center', lineHeight: 26 },
  ...
  btnTxt: { fontSize: 16, fontFamily: 'Nunito-SemiBold', color: '#fff', letterSpacing: 0.5 },
});
