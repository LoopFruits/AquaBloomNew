...
const s = StyleSheet.create({
  ...
  permTitle: { fontSize: 14, fontFamily: 'Nunito-SemiBold', color: ROSE },
  permText: { fontSize: 12, fontFamily: 'Nunito-Regular', color: '#6b7280', marginTop: 2 },
  ...
  label: { fontSize: 14, fontFamily: 'Nunito-Medium', color: '#e8eaed' },
  time: { fontSize: 12, fontFamily: 'Nunito-Regular', color: '#6b7280', marginTop: 1 },
  ...
  noteText: { flex: 1, fontSize: 12, fontFamily: 'Nunito-Regular', color: '#9ba3af', lineHeight: 18 },
});
